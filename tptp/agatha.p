%--------------------------------------------------------------------------
% File     : PUZ001-2 : TPTP v6.1.0. Released v1.0.0.
% Domain   : Puzzles
...
% Rating   : 0.00 v6.1.0, 0.07 v6.0.0, 0.00 v5.5.0, 0.10 v5.4.0, 0.05 v5.3.0, 0.11 v5.2.0, 0.00 v5.1.0, 0.06 v5.0.0, 0.07 v4.1.0, 0.08 v4.0.1, 0.09 v3.7.0, 0.00 v3.4.0, 0.08 v3.3.0, 0.21 v3.2.0, 0.15 v3.1.0, 0.18 v2.7.0, 0.17 v2.6.0, 0.10 v2.5.0, 0.17 v2.4.0, 0.00 v2.3.0, 0.11 v2.2.1, 0.11 v2.2.0, 0.11 v2.1.0, 0.00 v2.0.0
...
fof(someone_in_mansion,axiom,
    ( lives_at_dreadsbury(someone) )).

fof(someone_killed_agatha,axiom,
    ( killed(someone,aunt_agatha) )).

fof(agatha_lives_at_mansion,axiom,
    ( lives_at_dreadsbury(aunt_agatha) )).

fof(butler_lives_at_mansion,axiom,
    ( lives_at_dreadsbury(butler) )).

fof(charles_lives_at_mansion,axiom,
    ( lives_at_dreadsbury(charles) )).

fof(noone_else_lives_at_mansion,axiom,
...
fof(killer_poorer_than_victim,axiom,
    ( ~ killed(Killer,Victim)
    | ~ richer(Killer,Victim) )).

fof(charles_and_agatha_hate_different_people,axiom,
    ( ~ hates(aunt_agatha,Person)
    | ~ hates(charles,Person) )).

fof(agatha_likes_only_butler,axiom,
    ( Person = butler
    | hates(aunt_agatha,Person) )).

fof(butler_hates_poor_people,axiom,
    ( richer(Person,aunt_agatha)
    | hates(butler,Person) )).

fof(butler_and_agatha_hate_the_same_people,axiom,
    ( ~ hates(aunt_agatha,Person)
    | hates(butler,Person) )).

fof(noone_hates_everyone,axiom,
    ( ~ hates(Person,every_one_but(Person)) )).

fof(agatha_is_not_the_butler,axiom,
    (  aunt_agatha != butler )).

fof(prove_agatha_killed_herself,conjecture,
