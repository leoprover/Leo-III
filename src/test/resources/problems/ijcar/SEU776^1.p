%------------------------------------------------------------------------------
% File     : SEU776^1 : TPTP v6.2.0. Released v3.7.0.
% Domain   : Set Theory
...
% Status   : Theorem
% Rating   : 0.86 v5.5.0, 0.83 v5.4.0, 0.80 v5.2.0, 1.00 v3.7.0
% Syntax   : Number of formulae    :  637 ( 294 unit; 339 type; 297 defn)
%            Number of atoms       : 5377 ( 427 equality;2424 variable)
%            Maximal formula depth :  305 (   7 average)
%            Number of connectives : 3871 (  73   ~;  12   |;  46   &;2807   @)
%                                         (  14 <=>; 919  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&;   0  !!;   0  ??)
%            Number of type conns  :  154 ( 154   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :  344 ( 339   :)
%            Number of variables   : 1031 (   1 sgn; 915   !;  36   ?;  80   ^)
%                                         (1031   :;   0  !>;   0  ?*)
%                                         (   0  @-;   0  @+)
% SPC      : TH0_THM_EQU
