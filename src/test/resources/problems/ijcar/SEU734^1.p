%------------------------------------------------------------------------------
% File     : SEU734^1 : TPTP v6.2.0. Released v3.7.0.
% Domain   : Set Theory
...
% Status   : Theorem
% Rating   : 0.29 v6.1.0, 0.43 v5.5.0, 0.50 v5.4.0, 0.60 v5.2.0, 1.00 v3.7.0
% Syntax   : Number of formulae    :  543 ( 252 unit; 288 type; 254 defn)
%            Number of atoms       : 4221 ( 380 equality;1873 variable)
%            Maximal formula depth :  260 (   6 average)
%            Number of connectives : 2912 (  65   ~;  12   |;  44   &;2069   @)
%                                         (  14 <=>; 708  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&;   0  !!;   0  ??)
%            Number of type conns  :  132 ( 132   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :  293 ( 288   :)
%            Number of variables   :  853 (   1 sgn; 744   !;  35   ?;  74   ^)
%                                         ( 853   :;   0  !>;   0  ?*)
%                                         (   0  @-;   0  @+)
% SPC      : TH0_THM_EQU
