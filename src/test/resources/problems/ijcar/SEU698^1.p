%------------------------------------------------------------------------------
% File     : SEU698^1 : TPTP v6.2.0. Released v3.7.0.
% Domain   : Set Theory
...
% Status   : Theorem
% Rating   : 0.29 v6.1.0, 0.43 v5.5.0, 0.50 v5.4.0, 0.60 v5.2.0, 0.80 v5.0.0, 0.60 v4.1.0, 1.00 v4.0.0, 0.67 v3.7.0
% Syntax   : Number of formulae    :  472 ( 216 unit; 251 type; 220 defn)
%            Number of atoms       : 3485 ( 330 equality;1524 variable)
%            Maximal formula depth :  227 (   6 average)
%            Number of connectives : 2333 (  47   ~;   7   |;  35   &;1665   @)
%                                         (  14 <=>; 565  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&;   0  !!;   0  ??)
%            Number of type conns  :  129 ( 129   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :  256 ( 251   :)
%            Number of variables   :  732 (   1 sgn; 622   !;  36   ?;  74   ^)
%                                         ( 732   :;   0  !>;   0  ?*)
%                                         (   0  @-;   0  @+)
% SPC      : TH0_THM_EQU

% Comments : http://mathgate.info/detsetitem.php?id=250
%          : 
%------------------------------------------------------------------------------
thf(in_type,type,(
    in: $i > $i > $o )).
