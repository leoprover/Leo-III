%------------------------------------------------------------------------------
% File     : NUN024^2 : TPTP v6.4.0. Released v6.4.0.
% Domain   : Number Theory
% Problem  : Function h s.t. h(0) = 1, h(1) = 0, h(2) = 0, with witness
% Version  : Especial.
...
% Source   : [TPTP]
% Names    : ntape6-1-with-witness.tptp [Rie16]

% Status   : Theorem
% Rating   : 0.29 v6.4.0
% Syntax   : Number of formulae    :    5 (   0 unit;   4 type;   0 defn)
%            Number of atoms       :   48 (   9 equality;  18 variable)
%            Maximal formula depth :   12 (   5 average)
%            Number of connectives :   32 (   3   ~;   0   |;   6   &;  20   @)
%                                         (   0 <=>;   3  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
