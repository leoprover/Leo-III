...
object TermTest {
  def main (args: Array[String]) {
    ...
    val t1 = Term.mkTermAbs(Type.i, Term.mkTermApp((0,Type.i), (1, Type.i)))

    val t2 = Term.mkTermAbs(Type.i, Term.mkTermApp(t1, Term.mkAtom(B)))


    val neuB = Term.mkTermAbs(Type.i, Term.mkTermApp((1,Type.i), (0, Type.i)))
    val t3 = Term.mkTermAbs(Type.i, Term.mkTermApp(t1, neuB))

    val t1neu = Term.mkTermAbs(Type.i, Term.mkTermApp((0,Type.i), Term.mkTermAbs(Type.i, (1,Type.i))))
    val t4 = Term.mkTermAbs(Type.i, Term.mkTermApp(t1neu, neuB))
    println(t1neu.pretty)
    println(t4.pretty)
