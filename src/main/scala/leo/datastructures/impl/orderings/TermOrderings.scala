...
//import leo.datastructures.{ Orderings, Type, Term}
...
//
//  @tailrec
//  def compareType(a: Type, b: Type): CMP_Result = {
...
//    } else {
//      (a,b) match {
//        case (BaseType(keyA), BaseType(keyB)) => intToCMPRes(keyA, keyB) // Order of base types given by their id in signature
