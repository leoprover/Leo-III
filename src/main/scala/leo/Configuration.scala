...
object Configuration extends DefaultConfiguration {
  ...
  final val VERSION: String = "1.7.19"
  ...
  lazy val EMBEDDING_PARAMS: Seq[String] = {
    valueOf(PARAM_PASSTOEMBEDDING) match {
      case None => Seq.empty
...
trait DefaultConfiguration {
  ...
  val DEFAULT_UNIFIERCOUNT = 4
  val DEFAULT_PRIMSUBST = 3
